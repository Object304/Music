...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->сохранитьToolStripMenuItem->Size = System::Drawing::Size(270, 34);
			...
			this->сохранитьКакToolStripMenuItem->Size = System::Drawing::Size(270, 34);
			...
			this->выходToolStripMenuItem->Size = System::Drawing::Size(270, 34);
...
#pragma endregion
	...
	private: System::Void сохранитьToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		char* name = "C:\\Users\\Zhon1\\Desktop\\Песни\\MyFile.txt";
		std::ifstream in(name);
		if (!in) {
	...
	private: System::Void btn_autoFill_Click(System::Object^ sender, System::EventArgs^ e) {
		char* name = "C:\\Users\\Zhon1\\Desktop\\Песни\\AutoFill.txt";
		std::ifstream in(name);
		if (!in)
			MessageBox::Show("Не удалось открыть файл " + ofdOpen->FileName + " для чтения");
		else {
